...
def compute_ground_truth(
    ...
    # Remove systematic offset between surveys
    # This accounts for datum/processing differences
    ...
    # Corrected difference (centered around zero for seafloor)
    difference = raw_difference - systematic_offset
    
    # Classify based on corrected difference
    ...
    ds = driver.Create(
        str(output_path),
        width, height, 5,  # 5 bands: labels, difference, noisy_depth, clean_depth, uncertainty
        gdal.GDT_Float32,
